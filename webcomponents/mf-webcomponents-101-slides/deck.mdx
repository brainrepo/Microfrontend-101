...
<img
  style={{ width: "100%" }}
  src="https://i2.wp.com/josephmuciraexclusives.com/wp-content/uploads/2020/01/AMP-Plugin-for-WordPress.jpg?fit=1000%2C500&ssl=1"
/>
...
<img
  style={{ width: "100%" }}
  src="https://www.genitoriorganizzati.it/wp-content/uploads/2014/10/candelelego.jpg"
/>
...
<img
  style={{ width: "100%" }}
  src="https://images.thecarconnection.com/med/delorean-dmc-12-time-machine-from-back-to-the-future_100367456_m.jpg"
/>
...
<img
  style={{ width: "100%" }}
  src="https://images-na.ssl-images-amazon.com/images/I/51wUg1uxfaL._AC_SY450_.jpg"
/>
...
<img
  style={{ width: "100%", height: "100%" }}
  src="https://media.giphy.com/media/hOzfvZynn9AK4/giphy.gif"
/>
...
<img
  style={{ width: "100%", height: "100%" }}
  src="https://media.giphy.com/media/H4buZ6PLgwsKjA9hlO/giphy.gif"
/>
...
<img
  style={{ width: "100%", height: "100%" }}
  src="https://images-na.ssl-images-amazon.com/images/I/91GNwajiVKL._AC_SX450_.jpg"
/>
...
<img
  style={{ width: "100%", height: "100%" }}
  src="https://media.giphy.com/media/3oKIPj5Xk0P8J574wU/giphy.gif"
/>
...
<div>Mi catturo il contenuto del template</div>
...
<div>Lo appendo allo shadow dom</div>
...
<div>Il codice del template, che incapsula anche uno stile</div>
...
<div style={{width: "40vw"}}>lit-elements</div>

<div style={{width: "40vw"}}>stencil</div>
...
LitElement semplifica la definizione dei componenti Web, 

- condividere elementi all'interno dell'organizzazione
- per creare un sistema di progettazione dell'interfaccia utente.

---
<CodeSurferColumns themes={[github, vsDark]}>

<Step title="Uso di lit elements">
...
<Step title="markup del componente custom definito con litelements">
...
# Perché usare lit elements

---

## dichiarativo

Esprimi la tua interfaccia utente in modo dichiarativo, in funzione dello stato. 

Gli elementi si aggiornano automaticamente quando le loro proprietà cambiano.

---

## Veloce e leggero

LitElement è estremamente veloce.

LitElement utilizza lit-html per definire e visualizzare i modelli HTML. 

Gli aggiornamenti DOM sono velocissimi, perché lit-html riproduce solo 
le parti dinamiche della tua interfaccia utente, 
**non sono richieste differenze**.

---

## Interoperabile

LitElement segue gli standard dei componenti Web, 
quindi i componenti funzioneranno con **qualsiasi framework**.

LitElement utilizza elementi personalizzati per una facile inclusione 
nelle pagine web e Shadow DOM per l'incapsulamento. 

Non ci sono nuove astrazioni sulla piattaforma web.
...
<img src="https://media1.giphy.com/media/nCVVpakhBTwBi/200.gif" style={{width: '30vw'}} />

</Split>

---

Per la creazione del progetto usiamo lo script di scaffolding di open-wc

<img src="https://desarrolloweb.com/archivoimg/general/4713.png" style={{width: '30vw'}} />

`https://open-wc.org/init/`

---

Lancio il comando per l'inizializzazione
...
Rispondiamo a tutte le richieste e alla fine il sistema genererà tutti i file necessari per la creazione 
del componente
